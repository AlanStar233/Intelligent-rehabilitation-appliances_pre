...
//      osal_memcpy(buffer,pkt->cmd.Data,7);
      if(pkt->cmd.Data[6]=='X')
      {
        type_change(pkt->cmd.Data[0]);
        HalUARTWrite(0,"  ",2);
        type_change(pkt->cmd.Data[1]);
        HalUARTWrite(0,"  ",2);
        type_change(pkt->cmd.Data[2]);
        HalUARTWrite(0,"  ",2);
      
        type_change(pkt->cmd.Data[3]);
        HalUARTWrite(0,"  ",2);
        type_change(pkt->cmd.Data[4]);
        HalUARTWrite(0,"  ",2);
        type_change(pkt->cmd.Data[5]);
        HalUARTWrite(0,"\n",1);
